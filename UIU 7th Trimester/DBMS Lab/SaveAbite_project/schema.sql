...
DROP DATABASE IF EXISTS saveabite;
CREATE DATABASE saveabite;
USE saveabite;
...
CREATE TABLE users (
    ...
    user_type ENUM('donor', 'volunteer', 'user', 'admin') NOT NULL DEFAULT 'user',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE food_listings (
    ...
    status ENUM('Available', 'Claimed', 'In Transit', 'Delivered', 'Expired') DEFAULT 'Available',
...
CREATE TABLE monetary_donations (
    ...
    payment_method VARCHAR(50) DEFAULT 'Card/MFS',
...
INSERT INTO users (name, email, password, user_type, zone_id) 
VALUES ('System Admin', 'admin@saveabite.com', 'admin123', 'admin', 1);
